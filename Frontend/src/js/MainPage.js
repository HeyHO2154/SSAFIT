...
export default {
  ...
  data() {
    return {
      ...
      customStyles: [
        { left: '11.3%', top: '44.3%' }, // 1번 버튼 위치
        { left: '22%', top: '44.3%' }, // 2번 버튼 위치
        { left: '30.5%', top: '59.1%' }, // 3번 버튼 위치
        { left: '42.2%', top: '59.1%' }, // 4번 버튼 위치
        { left: '56.8%', top: '26.4%' }, // 5번 버튼 위치
        { left: '75.6%', top: '26.4%' }, // 6번 버튼 위치
        { left: '87.1%', top: '42.1%' }, // 7번째 버튼 위치
      ],
